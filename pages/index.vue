<template>
  ...
  <div class="top-bar-bg">
    ...
    >
      <p style="margin-left: 367px; cursor: pointer;">&lt;&lt;</p>
    </div>
    <div
      class="text-white fs-2"
      @click="hideScheduler"
  ...
  <div
    ...
    v-show="hideSchedulerBar"
  >
    <img src="/images/svg/calander.svg" alt="calendar" style="height: 233px" />
    <div
  ...
  >
    <img src="/images/svg/calander.svg" alt="calender" style="height: 233px" />
    <div
...
const { data: categoryData } = useCustomFetch<any>("/category/get/categories", {
  method: "POST",
  body: { facility_id: currentUserType?.id },
});

const { data: roomData } = useCustomFetch<any>("/space/get/categories", {
  method: "POST",
  body: { facility_id: currentUserType?.id },
});
...
const { data: weekData, refresh: weekDataRefresh } = useCustomFetch<any>(
