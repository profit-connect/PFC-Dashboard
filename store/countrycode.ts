...
export const useCountryStore = defineStore("countrycode", () => {
  const CountryCodes = [
      ...
      { label: "AmericanSamoa (+1684)", value: "+1684" },
      ...
      { label: "Iran, Islamic Republic of Persian Gulf (+98)", value: "+98" },
      ...
      { label: "Tanzania, United Republic of Tanzania (+255)", value: "+255" },
